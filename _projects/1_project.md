...
We compare our results to an End-to-End Deep Learning method. 

The process of deblurring an image can be reduced into finding an optimal kernel to apply on the blurred image.
However, estimating the deblur kernel from a random gaussian process is challenging. 
